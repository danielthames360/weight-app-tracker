...
watch(
  ...
  (newWeights) => {
    const ws = [...newWeights];
    weightInput.value = ws.sort((a, b) => b.date - a.date)[0].weight;
          ...
          datasets: [
            {
              ...
              backgroundColor: "rgba(72, 144, 167, 0.2)",
              borderColor: "rgb(72, 144,167)",
              borderWidth: 1,
              fill: true,
            },
          ],
...
.current {
  ...
  border: 5px solid rgb(72, 144, 167);
...
form input[type="submit"] {
  ...
  border: none;
  cursor: pointer;
  background-color: rgb(72, 144, 167);
  padding: 0.5rem 1rem;
  color: white;
  font-size: 1.25rem;
  font-weight: 700;
...
form input[type="submit"]:hover {
  ...
  border-left-color: rgb(72, 144, 167);
}
.canvas-box {
  width: 100%;
  max-width: 100%;
